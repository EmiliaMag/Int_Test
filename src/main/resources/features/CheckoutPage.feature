...
#    And customer clicks on Country field and selects "Argentina"
    ...
    And customer clicks on "State/Province" dropdown list and selects "Arizona" from the list
    And customer clicks on "ZIP/Postal Code" field and types "85018" in the "Zip" field
